...
class PlatformFactory:
    ...
    @staticmethod
    def create(platform_type: str, config: Optional[Dict[str, Any]] = None) -> PlatformProvider:
        """
...
class ConverterFactory:
    ...
    @staticmethod
    def create_converter(platform_type: str, llm_provider: Optional[LLMProvider] = None, 
                        config: Optional[Dict[str, Any]] = None) -> 'ContentConverter':
        """
